...
(function() {
    ...
    d.addZeroes = function(a, b, c) {
        ...
        return a[1].length < c ? (a[1] += "0", d.addZeroes(a[0] + b + a[1], b, c)) :
        ...
        afterWrite : function(a) {
            if ( a = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                if (e) {
                    ...
                    if (e.enabled)
                        switch(g.left=null,g.top=null,g.right=null,f.left=null,
                        f.right=null,f.top=null,g.position="relative",f.position="relative",e.position) {
                        case "bottom":
                            k.appendChild(b);
                            k.appendChild(c);
                            break;
        ...
        draw : function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var q = this.horizontalPadding, u = this.verticalPadding, z = this.pointerWidth, B = this.pointerOrientation, y = this.cornerRadius, v = c.fontFamily, A = this.fontSize;
                    ...
                    C.position = "absolute";
                    var w = this.minWidth, x = "";
                    isNaN(w) || ( x = "min-width:" + (w - 2 * q) + "px; ");
                    n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + x + "max-width:" + this.maxWidth + "px; font-size:" + A + "px; color:" + this.color + "; font-family:" + v + '">' + this.text + "</div>";
                    c.chartDiv.appendChild(n);
                    this.textDiv = n;
                    var F = n.offsetWidth, D = n.offsetHeight;
                    n.clientHeight && ( F = n.clientWidth, D = n.clientHeight);
                    v = D + 2 * u;
                    x = F + 2 * q;
                    !isNaN(w) && x < w && ( x = w);
                    window.opera && (v += 2);
                    ...
                    "H" != B ? ( w = a - x / 2, b < k + v + 10 && "down" != B ? ( H = !0, e && (b += A), A = b + z, this.deltaSignY = -1) : (e && (b -= A), A = b - v - z, this.deltaSignY = 1)) : (2 * z > v && ( z = v / 2), A = b - v / 2, a < h + (l - h) / 2 ? ( w = a + z, this.deltaSignX = -1) : ( w = a - x - z, this.deltaSignX = 1));
                    A + v >= m && ( A = m - v);
                    A < k && ( A = k);
                    w < h && ( w = h);
                    w + x > l && ( w = l - x);
                    ...
                    this.showBullet && ( J = d.circle(g, K, p, u), f.push(J));
                    this.drop ? ( h = x / 1.6, l = 0, "V" == B && ( B = "down"), "H" == B && ( B = "left"), "down" == B && ( w = a + 1, A = b - h - h / 3), "up" == B && ( l = 180, w = a + 1, A = b + h + h / 3), "left" == B && ( l = 270, w = a + h + h / 3 + 2, A = b), "right" == B && ( l = 90, w = a - h - h / 3 + 2, A = b), k = A - D / 2 + 1, m = w - F / 2 - 1, r = d.drop(g, h, l, r, u, q, t, L)) : 0 < y || 0 === z ? (0 < G && ( a = d.rect(g, x, v, r, 0, q + 1, E, G, y), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), r = d.rect(g, x, v, r, u, q, t, L, y)) : ( p = [], y = [], "H" != B ? ( h = a - w, h > x - z && ( h = x - z), h < z && ( h = z), p = [0, h - z, a - w, h + z, x, x, 0, 0], y = H ? [0, 0, b - A, 0, 0, v, v, 0] : [v, v, b - A, v, v, 0, 0, v]) : ( B = b - A, B > v - z && ( B = v - z), B < z && ( B = z), y = [0, B - z, b - A, B + z, v, v, 0, 0], p = a < h + (l - h) / 2 ? [0, 0, w < a ? 0 : a - w, 0, 0, x, x, 0] : [x, x, w + x > a ? x : a - w, x, x, 0, 0, x]), 0 < G && ( a = d.polygon(g, p, y, r, 0, q, E, G), a.translate(1, 1), f.push(a)), r = d.polygon(g, p, y, r, u, q, t, L));
                    this.bg = r;
                    f.push(r);
                    r.toFront();
...
(function() {
    ...
    d.bullet = function(a, b, c, e, g, f, h, k, l, m, n, r, t) {
        ...
        case "round":
            ...
            break;
        case "square":
            p = d.polygon(a, [-c / 2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180,
            void 0, t);
            break;
        case "rectangle":
            p = d.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180,
            void 0, t);
            break;
        case "diamond":
    ...
    d.makeHD = function(a, b, c) {
        for (var e = [], d = [], f = 1; f < a.length; f++)
            for (var h = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.round(Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - h) / n, m = (m - k) / n, r = 0; r <= n; r++) {
    ...
    d.drop = function(a, b, c, e, d, f, h, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, r = Math.cos(m * l) * b, t = Math.sin((m + 40) * l) * b, p = Math.cos((m + 40) * l) * b, q = .8 * b, u = -b / 3, z = b / 3;
        0 === c && ( u = -u, z = 0);
        180 == c && ( z = 0);
        90 == c && ( u = 0);
        270 == c && ( u = 0, z = -z);
    ...
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, r, t, p) {
        ...
        h = q(h);
        k = q(k);
        var u = q(h / f * k), z = d.VML, B = 359.5 + f / 100;
        359.94 < B && ( B = 359.94);
        g >= B && ( g = B);
        var y = 1 / 180 * Math.PI, B = b + Math.sin(e * y) * k, v = c - Math.cos(e * y) * u, A = b + Math.sin(e * y) * f, C = c - Math.cos(e * y) * h, w = b + Math.sin((e + g) * y) * f, x = c - Math.cos((e + g) * y) * h, F = b + Math.sin((e + g) * y) * k, y = c - Math.cos((e + g) * y) * u, D = {
        ...
        e = a.set();
        var G;
        z && ( B = q(10 * B), A = q(10 * A), w = q(10 * w), F = q(10 * F), v = q(10 * v), C = q(10 * C), x = q(10 * x), y = q(10 * y), b = q(10 * b), l = q(10 * l), c = q(10 * c), f *= 10, h *= 10, k *= 10, u *= 10, 1 > Math.abs(g) && 1 >= Math.abs(w - A) && 1 >= Math.abs(x - C) && ( G = !0));
        g = "";
        var E;
        r && (D["fill-opacity"] = 0, D["stroke-opacity"] = m["stroke-opacity"] / 2, D.stroke = m.stroke);
        if (0 < l) {
            E = " M" + B + "," + (v + l) + " L" + A + "," + (C + l);
            z ? (G || (E += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + w + "," + (x + l)), E += " L" + F + "," + (y + l), 0 < k && (G || (E += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," + (l + c + u) + "," + F + "," + (l + y) + "," + B + "," + (l + v)))) : (E += " A" + f + "," + h + ",0," + H + ",1," + w + "," + (x + l) + " L" + F + "," + (y + l), 0 < k && (E += " A" + k + "," + u + ",0," + H + ",0," + B + "," + (v + l)));
            E += " Z";
            var K = l;
            z && (K /= 10);
            for (var J = 0; J < K; J += 10) {
                var L = a.path(E,
                void 0,
                void 0, "1000,1000").attr(D);
                e.push(L);
                L.translate(0, -J)
            }
            E = a.path(" M" + B + "," + v + " L" + B + "," + (v + l) + " L" + A + "," + (C + l) + " L" + A + "," + C + " L" + B + "," + v + " Z",
            void 0,
            void 0, "1000,1000").attr(D);
            l = a.path(" M" + w + "," + x + " L" + w + "," + (x + l) + " L" + F + "," + (y + l) + " L" + F + "," + y + " L" + w + "," + x + " Z",
            void 0,
            void 0, "1000,1000").attr(D);
            e.push(E);
            e.push(l)
        }
        z ? (G || ( g = " A" + q(b - f) + "," + q(c - h) + "," + q(b + f) + "," + q(c + h) + "," + q(A) + "," + q(C) + "," + q(w) + "," + q(x)), h = " M" + q(B) + "," + q(v) + " L" + q(A) + "," + q(C) + g + " L" + q(F) + "," + q(y)) : h = " M" + B + "," + v + " L" + A + "," + C + (" A" + f + "," + h + ",0," + H + ",1," + w + "," + x) + " L" + F + "," + y;
        0 < k && ( z ? G || (h += " B" + (b - k) + "," + (c - u) + "," + (b + k) + "," + (c + u) + "," + F + "," + y + "," + B + "," + v) : h += " A" + k + "," + u + ",0," + H + ",0," + B + "," + v);
        a.handDrawn && ( k = d.line(a, [B, A], [v, C], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(k));
        k = a.path(h + " Z",
        void 0,
        void 0, "1000,1000").attr(m);
        if (n) {
            u = [];
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend : function() {
            ...
            c =
            void 0 !== c ? d.toCoordinate(c, e) : "right" != b && "left" != b ? a.realWidth : 0 < this.ieW ? this.ieW : a.realWidth;
        ...
        arrangeEntries : function() {
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, g = this.marginBottom, f = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, r = k - c - b, t = 0, p = 0, q = this.container;
            ...
            var A = p = 0, C = f, w = 0, x = 0;
            for ( v = 0; v < B.length; v++) {
                var F = B[v];
                this.reversedOrder && ( F = B[B.length - v - 1]);
                y = F.getBBox();
                var D;
                this.equalWidths ? D = A * (t + n + this.markerLabelGap) : ( D = C, C = C + y.width + f + n);
                y.height > x && ( x = y.height);
                D + y.width > r && 0 < v && 0 !== A && (p++, D = A = 0, C = D + y.width + f + n, w = w + x + m, x = 0);
                F.translate(D, w);
                A++;
                !isNaN(l) && A >= l && ( A = 0, p++, w = w + x + m, C = f, x = 0);
                z.push(F)
            }
            y = z.getBBox();
            l = y.height + 2 * m - 1;
            "left" == a || "right" == a ? ( n = y.width + 2 * f, k = n + b + c, h.style.width = k + "px", this.ieW = k) : n = k - b - c - 1;
        ...
        createEntry : function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    ( h = this.createMarker(c, e, g,
                    void 0,
                    void 0,
                    void 0, q, h)) && h.translate(m / 2, m / 2)
                }
                ...
                p = this.fontSize;
                h && (m <= p && ( m = m / 2 + this.ly - p / 2 + (p + 2 - m) / 2 - r, h.translate(t, m), u && u.translate(u.x, m)), a.legendEntryWidth = h.getBBox().width);
                var z;
                e && ( e = d.fixBrakes(e), a.legendTextReal = e, z = this.labelWidth, z = isNaN(z) ? d.text(this.container, e, f, b.fontFamily, p, "start") : d.wrappedText(this.container, e, f, b.fontFamily, p, "start", !1, z, 0), d.setCN(b, z, "legend-label"), z.translate(this.lx + n, this.ly), l.push(z), b = z.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
    ...
    d.AmMap = d.Class({
        ...
        buildEverything : function() {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.drawBg();
                this.buildSVGMap();
                this.projectionFunction && c != b.projection ? (this.normalizeMap(), this.changeProjection()) : this.fixMapPosition();
                if ( c = this.smallMap)
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if ( a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        ...
                        if (!isNaN(q)) {
                            var k = b.initialTouchZoom * p / q, k = d.fitToBounds(k, h.minZoomLevel, h.maxZoomLevel), h = b.zoomLevel(), q = b.middleXP, l = b.middleYP, p = m / t, u = n / r, q = (b.zoomX() - q * u) * (k / h) + q * u, l = (b.zoomY() - l * p) * (k / h) + l * p;
                            .1 < Math.abs(k - h) && (b.zoomTo(k, q, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (g - c), e = a.y + (f - e), b.preventDragOut && ( t = -t * k + m / 2, m /= 2, c = d.fitToBounds(c, -r * k + n / 2, n / 2), e = d.fitToBounds(e, t, m)), isNaN(c) || isNaN(e) || (a.translate(c, e, k, !0), b.updateSmallMap()));
                    b.previuosMouseX = g;
                    b.previuosMouseY = f
                }
            }
        ...
        returnInitialColorReal : function(a) {
            ...
            if (b) {
                ...
                ( b = a.imageLabel) && !a.labelInactive && (a.showAsSelected &&
                void 0 !== a.selectedLabelColor ? b.setAttr("fill", a.selectedLabelColor) : b.setAttr("fill", a.labelColorReal))
            }
        },
        ...
        showAsRolledOver : function(a) {
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                a.preserveOriginalAttributes && ( c =
                void 0);
        ...
        rollOverMapObject : function(a, b, c) {
            if (this.chartCreated) {
                ...
                if (!this.preventHover) {
                    ...
                    this.showDescriptionOnHover ? this.showDescription(a) : !this.showBalloonOnSelectedObject && this.checkIfSelected(a) || !1 === b || ( g = this.balloon, this.balloon.fixedPosition = !1, b = a.colorReal, d = "",
                    void 0 !== b && this.useObjectColorForBalloon || ( b = g.fillColor), ( g = a.balloonTextReal) && ( d = this.formatString(g, a)), this.balloonLabelFunction && ( d = this.balloonLabelFunction(a, this)), "MapArea" != a.objectType && (this.balloonX = NaN), d && "" !== d && this.showBalloon(d, b, !1, this.balloonX, this.balloonY));
                    this.fire({
                ...
                for ( g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        if (3 == f.nodeType || 4 == f.nodeType) {
                            ...
                            var r;
                            void 0 !== a[b][l] ?
                            void 0 === a[b][l].length ? ( r = a[b][l], a[b][l] = [], a[b][l].push(r), a[b][l].push({}), r = a[b][l][1]) : "object" == typeof a[b][l] && (a[b][l].push({}), r = a[b][l][a[b][l].length - 1]) : (a[b][l] = {}, r = a[b][l]);
...
(function() {
    ...
    d.ZoomControl = d.Class({
        construct : function(a) {
            ...
            this.gridColor = this.buttonIconColor = "#ff0000";
            ...
            this.draggerSize = this.buttonSize = 60;
             this.iconSize = 11;             
        ...
        init : function(a, b) {
            ...
            var g = c.buttonSize, f = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor, l = c.buttonFillAlpha, m = c.buttonBorderThickness, n = c.buttonBorderColor, r = c.buttonBorderAlpha, t = c.buttonCornerRadius, p = c.buttonRollOverColor, q = c.gridHeight, u = c.zoomFactor, z = c.minZoomLevel, B = c.maxZoomLevel, y = c.buttonIconAlpha, v = c.buttonIconColor, A = c.roundButtons, C = a.svgIcons, w = a.getX(c.left), x = a.getY(c.top);
            isNaN(c.right) || ( w = a.getX(c.right, !0), w = h ? w - 3 * g : w - g);
            isNaN(c.bottom) || ( x = a.getY(c.bottom, !0), f && (x -= q + 3 * g), x = h ? x - 3 * g : c.homeButtonEnabled ? x - .5 * g : x + g);
            e.translate(w, x);
            c.previousDY = NaN;
            var F, w = g / 4 - 1;
            if (f) {
                ...
                c.set = e;
                c.zoomSet = F;
                5 < q && ( f = d.rect(b, g + 6, q + 2 * g + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, 0, 0, 4), d.setCN(a, f, "zoom-bg"), f.translate(-3, -3), f.mouseup(function() {
                    c.handleBgUp()
                }).touchend(function() {
                    c.handleBgUp()
                }), F.push(f));
                ...
                F.push(E);
                for ( G = 1; G < H; G++)
                    x = g + G * f, x = d.line(b, [1, D - 2], [x, x], c.gridColor, c.gridAlpha, 1), d.setCN(a, x, "zoom-grid"), E.push(x);
                ...
                c.previousY = NaN;
                x = new d.SimpleButton;
                C ? ( D = b.set(), H = d.line(b, [-w, w], [0, 0], v, y, 1), G = d.line(b, [0, 0], [-w, w], v, y, 1), D.push(H), D.push(G), x.svgIcon = D) : x.setIcon(a.pathToImages + "plus.gif", c.iconSize);
            ...
            h && ( h = b.set(), d.setCN(a, h, "zoom-control-pan"), e.push(h), F && F.translate(g, 4 * g), u = new d.SimpleButton, C ? u.svgIcon = d.line(b, [w / 5, -w + w / 5, w / 5], [-w, 0, w], v, y, 1) : u.setIcon(a.pathToImages + "panLeft.gif", c.iconSize), u.setClickHandler(a.moveLeft, a), u.init(b, g, g, k, l, m, n, r, t, p, y, v, A), u.set.translate(0, g), d.setCN(a, u.set, "pan-left"), h.push(u.set), u = new d.SimpleButton, C ? u.svgIcon = d.line(b, [-w / 5, w - w / 5, -w / 5], [-w, 0, w], v, y, 1) : u.setIcon(a.pathToImages + "panRight.gif", c.iconSize), u.setClickHandler(a.moveRight, a), u.init(b, g, g, k, l, m, n, r, t, p, y, v, A), u.set.translate(2 * g, g), d.setCN(a, u.set, "pan-right"), h.push(u.set), u = new d.SimpleButton, C ? u.svgIcon = d.line(b, [-w, 0, w], [w / 5, -w + w / 5, w / 5], v, y, 1) : u.setIcon(a.pathToImages + "panUp.gif", c.iconSize), u.setClickHandler(a.moveUp, a), u.init(b, g, g, k, l, m, n, r, t, p, y, v, A), u.set.translate(g, 0), d.setCN(a, u.set, "pan-up"), h.push(u.set), u = new d.SimpleButton, C ? u.svgIcon = d.line(b, [-w, 0, w], [-w / 5, w - w / 5, -w / 5], v, y, 1) : u.setIcon(a.pathToImages + "panDown.gif", c.iconSize), u.setClickHandler(a.moveDown, a), u.init(b, g, g, k, l, m, n, r, t, p, y, v, A), u.set.translate(g, 2 * g), d.setCN(a, u.set, "pan-down"), h.push(u.set), e.push(h));
...
(function() {
    ...
    d.AreasProcessor = d.Class({
        ...
        process : function(a) {
            ...
            b.minValueReal = k;
            for ( d = 0; d < c; d++)
                g = a[d], isNaN(g.value) ? g.percents =
                void 0 : (g.percents = (g.value - k) / f * 100, k == h && (g.percents = 100));
            for ( d = 0; d < c; d++)
        ...
        createArea : function(a) {
            ...
            var f = e.color, h = e.alpha, k = e.outlineThickness, l = e.rollOverColor, m = e.selectedColor, n = e.rollOverAlpha, r = e.rollOverBrightness, t = e.outlineColor, p = e.outlineAlpha, q = e.balloonText, u = e.selectable, z = e.pattern, B = e.rollOverOutlineColor, y = e.bringForwardOnHover, v = e.preserveOriginalAttributes;
            this.allObjects.push(a);
            a.chart = b;
            a.baseSettings = e;
            a.autoZoomReal =
            void 0 == a.autoZoom ? e.autoZoom : a.autoZoom;
            g = a.color;
            void 0 == g && ( g = f);
            var A = a.alpha;
            isNaN(A) && ( A = h);
            ...
            if (c && ( r = c.area, y = c.title, a.enTitle = c.title, y && !a.title && (a.title = y), ( c = b.language) ? ( y = d.mapTranslations) && ( c = y[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr =
            void 0, r)) {
                a.displayObject = r;
                ...
                a.preserveOriginalAttributes || (r.setAttr("fill", C), r.setAttr("stroke", f), r.setAttr("stroke-opacity", t), r.setAttr("stroke-width", p), r.setAttr("fill-opacity", A));
...
(function() {
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage : function(a, b) {
            ...
            a.remove && a.remove();
            var k = h.color, l = h.alpha, m = h.rollOverColor, n = h.rollOverOutlineColor, r = h.selectedColor, t = h.balloonText, p = h.outlineColor, q = h.outlineAlpha, u = h.outlineThickness, z = h.selectedScale, B = h.rollOverScale, y = h.selectable, v = h.labelPosition, A = h.labelColor, C = h.labelFontSize, w = h.bringForwardOnHover, x = h.labelRollOverColor, F = h.rollOverBrightness, D = h.selectedLabelColor;
            a.index = b;
            a.chart = c;
            ...
            a.centeredReal =
            void 0 == a.centered ? h.centered : a.centered;
            F = a.type;
            B = a.imageURL;
            z = a.svgPath;
            C = a.width;
            ...
            var E;
            B || F || z || ( F = "circle", C = 1, l = k = 0);
            q = y = 0;
            h = a.selectedColorReal;
            if (F) {
                isNaN(C) && ( C = 10);
                isNaN(D) && ( D = 10);
                "kilometers" == a.widthAndHeightUnits && ( C = c.kilometersToPixels(a.width), D = c.kilometersToPixels(a.height));
                "miles" == a.widthAndHeightUnits && ( C = c.milesToPixels(a.width), D = c.milesToPixels(a.height));
                if ("circle" == F || "bubble" == F)
                    D = C;
                E = this.createPredefinedImage(G, t, p, F, C, D);
                q = y = 0;
                a.centeredReal ? (isNaN(a.right) || ( y = C * n), isNaN(a.bottom) || ( q = D * n)) : ( y = C * n / 2, q = D * n / 2);
                E.translate(y, q, n, !0)
            } else
                B ? (isNaN(C) && ( C = 10), isNaN(D) && ( D = 10), E = e.image(B, 0, 0, C, D), E.node.setAttribute("preserveAspectRatio", "none"), E.setAttr("opacity", k), a.centeredReal && ( y = isNaN(a.right) ? -C / 2 : C / 2, q = isNaN(a.bottom) ? -D / 2 : D / 2, E.translate(y, q, NaN, !0))) : z && ( E = e.path(z), F = E.getBBox(), a.centeredReal ? ( y = -F.x * n - F.width * n / 2, isNaN(a.right) || ( y = -y), q = -F.y * n - F.height * n / 2, isNaN(a.bottom) || ( q = -q)) : y = q = 0, E.translate(y, q, n, !0), E.x = y, E.y = q);
            E && (H.push(E), a.image = E, E.setAttr("stroke-opacity", l), E.setAttr("stroke-width", p), E.setAttr("stroke", t), E.setAttr("fill-opacity", k), E.setAttr("fill", G), d.setCN(c, E, "map-image"),
            void 0 != a.id && d.setCN(c, E, "map-image-" + a.id));
            G = a.labelColorReal;
            !a.showAsSelected && c.selectedObject != a ||
            void 0 == h || (E.setAttr("fill", h), G = a.selectedLabelColorReal);
            E = null;
            void 0 !== a.label && ( E = d.text(e, a.label, G, c.fontFamily, a.labelFontSizeReal, a.labelAlign), d.setCN(c, E, "map-image-label"),
            void 0 !== a.id && d.setCN(c, E, "map-image-label-" + a.id), G = a.labelBackgroundAlpha, ( k = a.labelBackgroundColor) && 0 < G && ( l = E.getBBox(), e = d.rect(e, l.width + 16, l.height + 10, k, G), d.setCN(c, e, "map-image-label-background"),
            void 0 != a.id && d.setCN(c, e, "map-image-label-background-" + a.id), H.push(e), a.labelBG = e), a.imageLabel = E, H.push(E), d.setCN(c, H, "map-image-container"),
        ...
        updateSizeAndPosition : function(a) {
            ...
            if (a.lineId) {
                ...
                (a.line = q) && q.getCoordinates && (q.chart = b, q = q.getCoordinates(m, a.lineSegment)) && ( k = b.coordinateToLongitude(q.x), l = b.coordinateToLatitude(q.y), t = q.x, p = q.y, f = d.radiansToDegrees(q.angle))
            }
            isNaN(f) || c.rotate(f + a.extraAngle);
            if (!isNaN(e) && !isNaN(g))
                c.translate(e, g, NaN, !0);
            else if (!isNaN(l) && !isNaN(k))
                if ( g = b.coordinatesToXY(k, l), e = g.x, g = g.y, isNaN(t) || ( e = t), isNaN(p) || ( g = p), a.fixedSize) {
                    t = 1;
...
(function() {
    ...
    d.LinesProcessor = d.Class({
        ...
        createLine : function(a, b) {
            ...
            a.index = b;
            a.remove && a.remove();
            var c = this.chart, e = c.linesSettings, g = this.objectsToResize, f = c.mapLinesContainer, h = c.stageLinesContainer, k = e.thickness, l = e.dashLength, m = e.arrow, n = e.arrowSize, r = e.arrowColor, t = e.arrowAlpha, p = e.color, q = e.alpha, u = e.rollOverColor, z = e.selectedColor, B = e.rollOverAlpha, y = e.balloonText, v = e.bringForwardOnHover, A = e.arc, C = e.rollOverBrightness, w = c.container;
            a.chart = c;
            a.baseSettings = e;
            var x = w.set();
            a.displayObject = x;
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < q)
                    for ( v = [], C = [], B = 0; B < q; B++)
                        z = c.coordinatesToXY(n[B], e[B]), v.push(z.x), C.push(z.y);
                if (0 < v.length) {
                    a.segments = v.length;
                    d.dx = 0;
                    d.dy = 0;
                    ...
                    if (isNaN(n)) {
                        for ( n = 0; n < v.length - 1; n++)
                            H = Math.sqrt(Math.pow(v[n + 1] - v[n], 2) + Math.pow(C[n + 1] - C[n], 2)), a.distances[n] = H;
                    ...
                    if ("none" != A) {
                        var I, M, N;
                        if ("end" == A || "both" == A)
                            p = v[v.length - 1], q = C[C.length - 1], 1 < v.length ? ( k = v[v.length - 2], I = C[C.length - 2]) : ( k = p, I = q), I = 180 * Math.atan((q - I) / (p - k)) / Math.PI, isNaN(D) || (I += D), M = p, N = q, I = 0 > p - k ? I - 90 : I + 90;
                        "both" == A && ( p = d.polygon(w, [-t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r), x.push(p), p.translate(M, N, 1, !0), isNaN(I) || p.rotate(I), d.setCN(c, n, "map-line-arrow"),
                        void 0 != a.id && d.setCN(c, n, "map-line-arrow-" + a.id), a.fixedSize && g.push(p));
                        if ("start" == A || "both" == A)
                            p = v[0], N = C[0], 1 < v.length ? ( k = v[1], M = C[1]) : ( k = p, M = N), I = 180 * Math.atan((N - M) / (p - k)) / Math.PI, isNaN(D) || (I -= D), M = p, I = 0 > p - k ? I - 90 : I + 90;
                        "middle" == A && ( p = v[v.length - 1], q = C[C.length - 1], 1 < v.length ? ( k = v[v.length - 2], I = C[C.length - 2]) : ( k = p, I = q), M = k + (p - k) / 2, N = I + (q - I) / 2, I = 180 * Math.atan((q - I) / (p - k)) / Math.PI, isNaN(D) || ( D = H / 2, G -= Math.sqrt(G * G - D * D), 0 > y && ( G = -G), D = Math.sin(I / 180 * Math.PI), -1 == D && ( D = 1), M -= D * G, N += Math.cos(I / 180 * Math.PI) * G), I = 0 > p - k ? I - 90 : I + 90);
                        p = d.polygon(w, [-t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r);
                    ...
                    a.lineSvg = n;
                    a.showAsSelected && !isNaN(u) && n.setAttr("stroke", u);
...
(function() {
    ...
    d.MapLine = d.Class({
        ...
        getCoordinates : function(a, b) {
            ...
            if (!isNaN(a)) {
                var c, e, g, f, h, k;
                1 < this.longitudes.length ? ( e = this.chart.coordinatesToXY(this.longitudes[b], this.latitudes[b]), f = this.chart.coordinatesToXY(this.longitudes[b + 1], this.latitudes[b + 1]), c = e.x, g = f.x, e = e.y, f = f.y) : 1 < this.x.length && ( c = this.x[b], g = this.x[b + 1], e = this.y[b], f = this.y[b + 1]);
...
(function() {
    ...
    d.normalizePath = function(a) {
        for (var b = "", c = d.parsePath(a.getAttribute("d")), e, g, f = Infinity, h = -Infinity, k = Infinity, l = -Infinity, m = 0; m < c.length; m++) {
            var n = c[m], r = n.letter, t = n.x, n = n.y;
            "h" == r && ( r = "L", t += e, n = g);
            "H" == r && ( r = "L", n = g);
            "v" == r && ( r = "L", t = e, n += g);
            "V" == r && ( r = "L", t = e);
            if ("m" === r || "l" === r)
                r = r.toUpperCase(), t += e, n += g;
            t = d.roundTo(t, 3);
            n = d.roundTo(n, 3);
            e = t;
            g = n;
    ...
    d.winkel3.invert = function(a, b) {
        ...
        do
            var h = Math.cos(e), k = Math.sin(e), l = Math.sin(2 * e), m = k * k, n = h * h, r = Math.sin(c), t = Math.cos(c / 2), p = Math.sin(c / 2), q = p * p, u = 1 - n * t * t, z = u ? d.acos(h * t) * Math.sqrt( B = 1 / u) : B = 0, B, u = .5 * (2 * z * h * p + c / f) - a, y = .5 * (z * k + e) - b, v = .5 * B * (n * q + z * h * t * m) + .5 / f, A = B * (r * l / 4 - z * k * p), k = .125 * B * (l * p - z * k * n * r), m = .5 * B * (m * t + z * q * h) + .5, h = A * k - m * v, A = (y * A - u * m) / h, u = (u * k - y * v) / h, c = c - A, e = e - u;
        while((1E-6<Math.abs(A)||1E-6<Math.abs(u))&&0<--g);
        return [c, e]
    };
        ...
        init : function(a, b) {
            if (this.enabled) {
                ...
                if (this.showAsGradient)
                    c = d.rect(b, this.width, this.height, [c, e], 1, this.borderThickness, this.borderColor, 1, 0, 0), d.setCN(a, c, "value-legend-gradient"), c.translate(0, h), f.push(c);
                else
        ...
        addObjects : function(a, b) {
            ...
            if (a.images)
                for ( g = 0; g < a.images.length; g++)
                    f = a.images[g],
                    void 0 === f.showInList && (f.showInList = c.showImagesInList), this.addObject(f, d);
            if (a.lines)
                for ( g = 0; g < a.lines.length; g++)
                    f = a.lines[g],
                    void 0 === f.showInList && (f.showInList = c.showLinesInList), this.addObject(f, d);
